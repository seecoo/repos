...
int SJL06Cmd17(int hsmSckHDL,PUnionSJL06 pSJL06,char *bmkIndex1,char *bmkIndex2,char *keyValue1,char *keyValue2,char *errCode)
{
	int		ret;
	char		hsmCmdBuf[512+1];
	int		hsmCmdLen = 0;
...
int SJL06Cmd61(int hsmSckHDL,PUnionSJL06 pSJL06,char *bmkIndex1,char *bmkIndex2,char *keyValue1,char *keyValue2,char *pin1,char *pan,char *pin2,char *errCode)
{
	int		ret;
	char		hsmCmdBuf[512+1];
	int		hsmCmdLen = 0;
...
int SJL06Cmd81(int hsmSckHDL,PUnionSJL06 pSJL06,char *bmkIndex,char *mak,char *mac,int macDataLength,char *macData,char *errCode){
  ...
  if ((ret = UnionLongConnSJL06Cmd(hsmSckHDL,pSJL06,hsmCmdBuf,hsmCmdLen,hsmCmdBuf,sizeof(hsmCmdBuf))) < 0)
    {
      UnionUserErrLog("in SJL06Cmd81:: UnionLongConnSJL06Cmd!\n");
      return(ret);
    }
  hsmCmdBuf[ret] = 0;
