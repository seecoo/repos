...
int UnionPrintDesKey(PUnionDesKey pDesKey)
{
	...
	{
		case	con64BitsDesKey:
			printf("this is a 64 bits symmetry key.\n");
			break;
		case	con128BitsDesKey:
			printf("this is a 128 bits symmetry key.\n");
			break;
		case	con192BitsDesKey:
			printf("this is a 192 bits symmetry key.\n");
			break;
		default:
			printf("length of this des symmetry error!\n");
			break;
	}
#endif
...
int UnionGetNameOfDesKey(TUnionDesKeyType type,char *keyName)
{
	switch (type)
	{
		...
		case	conSelfDefinedKey:
			...
			break;
		case	conMKAC:	//Add By Huangbx, 20100518
			strcpy(keyName,"MKAC");
			break;
		case	conMKSMC:	//Add By Huangbx, 20100518
			strcpy(keyName,"MKSMC");
			break;
		default:
...
TUnionDesKeyType UnionConvertDesKeyType(char *keyTypeName)
{
	...
	if (strcmp(keyTypeName,"MKAC") == 0)	//Add By Huangbx, 20101130
		return(conMKAC);
	if (strcmp(keyTypeName,"MKSMC") == 0)	//Add By Huangbx, 20101130
		return(conMKSMC);	
	return(errCodeParameter);
}
...
int UnionGetNameOfDesKeyType(TUnionDesKeyType type,char *nameOfType)
{
	switch (type)
	{
		...
		case	conSelfDefinedKey:
			...
			break;
		case	conMKAC:	//Add By Huangbx, 20101130
			strcpy(nameOfType,"MKAC");
			break;
		case	conMKSMC:	//Add By Huangbx, 20101130
			strcpy(nameOfType,"MKSMC");
			break;
		default:
			return(errCodeParameter);
	}
