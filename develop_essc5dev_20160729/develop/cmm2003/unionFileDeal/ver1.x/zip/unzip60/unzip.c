...
/*  main() / UzpMain() stub  */
/*****************************/
#ifndef USE_UNZIPMAIN
int MAIN(argc, argv)   /* return PK-type error code (except under VMS) */
#else
int unzipMain(argc, argv)   /* return PK-type error code (except under VMS) */
#endif
    int argc;
    char *argv[];
{
...
/*---------------------------------------------------------------------------
  ...
  ---------------------------------------------------------------------------*/
...
#ifndef _WIN32_WCE /* Win CE does not support environment variables */
        if ((error = union_envargs(&argc, &argv, LoadFarStringSmall(EnvZipInfo),
...
#endif /* !NO_ZIPINFO */
    {
        uO.zipinfo_mode = FALSE;
#ifndef _WIN32_WCE /* Win CE does not support environment variables */
        if ((error = union_envargs(&argc, &argv, LoadFarStringSmall(EnvUnZip),
