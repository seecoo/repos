...
int      union_envargs         OF((int *Pargc, char ***Pargv,
...
# endif /* unused */
  ...
  char *union_utf8_to_local_string OF((ZCONST char *utf8_string, int escape_all));

  /* convert UTF-8 string to wide string */
  zwchar *union_utf8_to_wide_string OF((ZCONST char *utf8_string));

  /* convert wide string to multi-byte string */
  char *union_wide_to_local_string OF((ZCONST zwchar *wide_string, int escape_all));
...
# endif /* unused */
  ...
  char *union_wide_to_escape_string OF((unsigned long));

# define utf8_to_escaped_string(utf8_string) \
         union_utf8_to_local_string(utf8_string, TRUE)
