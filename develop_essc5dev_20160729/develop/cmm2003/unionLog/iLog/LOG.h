...
#define LOG_LEVEL_NOLOG		0	/* 不需要输出日志 */ /* no log */
#define LOG_LEVEL_OSERR		1	/* 严重错误等级 */ /* error level */
#define LOG_LEVEL_ERROR		2	/* 错误等级 */ /* error level */
#define LOG_LEVEL_INFO		3	/* 普通信息等级 */ /* info level */
#define LOG_LEVEL_DEBUG		4	/* 调试等级 */ /* debug level */
#define LOG_LEVEL_PGM		5	/* 调试等级 */ /* debug level */
#define LOG_LEVEL_ALL		6	/* 所有 */ /* debug level */
...
#define LOG_WRITEMODE_MULTI_FIRST	1	// 第一条
#define LOG_WRITEMODE_MULTI_Middle	2	// 中间
//#define LOG_WRITEMODE_MULTI_LAST	3	// 最后一条
...
/* 自定义定时初始化回调函数类型 */ /* timing init callback function */
...
#define LOG_BUFSIZE_DEFAULT		(64*1024)	/* 缺省日志缓冲区大小 */
#define LOG_BUFSIZE_MAX			(512*1024)	/* 最大日志缓冲区大小 */
