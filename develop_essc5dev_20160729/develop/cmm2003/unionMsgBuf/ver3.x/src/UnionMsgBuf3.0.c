...
int UnionGetAvailableMsgBufPos(PUnionMsgBufHDL pMsgBufHDL)
{
	...
	if ((Ret = msgrcv(pMsgBufHDL->QueueIDOfFreePos,&PosOfMsgBuf,sizeof(PosOfMsgBuf),0,~IPC_NOWAIT)) != sizeof(int))
	{
...
int UnionGetOccupiedMsgBufPos(PUnionMsgBufHDL pMsgBufHDL,long *TypeOfMsg)
{
	...
	if ((Ret = msgrcv(pMsgBufHDL->QueueIDOfOccupiedPos,&PosOfMsgBuf,sizeof(PosOfMsgBuf),0,~IPC_NOWAIT)) != sizeof(int))
	{
...
int UnionGetOccupiedMsgBufPosOfMsgType(PUnionMsgBufHDL pMsgBufHDL,long TypeOfMsg)
{
	...
	if ((Ret = msgrcv(pMsgBufHDL->QueueIDOfOccupiedPos,&PosOfMsgBuf,sizeof(PosOfMsgBuf),TypeOfMsg,~IPC_NOWAIT)) != sizeof(int))
	{
