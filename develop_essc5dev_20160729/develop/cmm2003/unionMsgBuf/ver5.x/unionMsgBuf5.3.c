...
int UnionReconnectMsgBufMDLAnyway()
{
	...
	{
		UnionUserErrLog("in UnionReconnectMsgBufMDLAnyway:: UnionInitMsgBufDef!\n");
		return(ret);
	}
	...
	{
		UnionUserErrLog("in UnionReconnectMsgBufMDLAnyway:: unsigned char *!\n");
		return(errCodeSharedMemoryModule);
	}
	...
	{
		UnionUserErrLog("in UnionReconnectMsgBufMDLAnyway:: UnionConnectIndexStatusTBL!\n");
...
int UnionReloadMsgBufDef()
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionReloadMsgBufDef:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}
...
long UnionApplyNewMsgIndexOfMsgBuf()
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionApplyNewMsgIndexOfMsgBuf:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
...
long UnionWriteNewMessage(unsigned char * msg,int lenOfMsg,long typeOfMsg,PUnionMessageHeader precvMsgHeader)
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionWriteNewMessage:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
	if ((msg == NULL) || (lenOfMsg > pgunionMsgBufHDL->msgBufDef.maxSizeOfMsg) || (typeOfMsg <= 0) || (lenOfMsg <= 0))
	{
...
int UnionWriteOriginMessage(unsigned char *msg,int lenOfMsg,PUnionMessageHeader pOriMsgHeader)
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionWriteOriginMessage:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
	if ((msg == NULL) || (pOriMsgHeader == NULL) 
...
int UnionReadMsgOfSpecifiedType(unsigned char *msg,int sizeOfMsg,long typeOfMsg,PUnionMessageHeader precvMsgHeader)
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionReadMsgOfSpecifiedType:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
	if ((msg == NULL) || (precvMsgHeader == NULL) || (typeOfMsg <= 0))
	{
...
int UnionReadMsgOfSpecifiedTypeUntilSuccess(unsigned char *msg,int sizeOfMsg,long typeOfMsg,PUnionMessageHeader precvMsgHeader)
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionReadMsgOfSpecifiedTypeUntilSuccess:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
	if ((msg == NULL) || (precvMsgHeader == NULL) || (typeOfMsg <= 0))
	{
...
int UnionReadOriginMessage(unsigned char *msg,int sizeOfMsg,PUnionMessageHeader pOriMsgHeader)
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionReadOriginMessage:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
	if ((msg == NULL) || (pOriMsgHeader == NULL))
	{
...
int UnionFreeRubbishMsg()
{
	...
	// 检查是否要重置消息缓冲区
	if (((num = UnionGetFreePosNumOfMsgBufMDL()) >= 0) && ((maxNum = UnionGetMaxNumOfMsg()) > 0))
	{
		if (((percent = UnionReadIntTypeRECVar("percentWhenResetMsgBuf")) < 50) || (percent > 95))
			percent = 95;
		if ((maxNum - num) * 100 / maxNum >= percent)
		{
			UnionAuditLog("in UnionFreeRubbishMsg:: reset msgBuf!\n");
			UnionResetAllMsgBufPosAvailable();
		}
	}
...
int UnionRebufferOriginMessage(unsigned char *msg,int lenOfMsg,PUnionMessageHeader pOriMsgHeader)
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionRebufferOriginMessage:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
...
int UnionReadFirstMsgOfTypeUntilSuccess(unsigned char *msg,int sizeOfMsg,long typeOfMsg)
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionReadFirstMsgOfTypeUntilSuccess:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
	if ((msg == NULL) || (typeOfMsg <= 0))
	{
...
int UnionBufferMessage(unsigned char * msg,int lenOfMsg,long typeOfMsg)
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionBufferMessage:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
	if ((msg == NULL) || (lenOfMsg > pgunionMsgBufHDL->msgBufDef.maxSizeOfMsg) || (typeOfMsg <= 0) || (lenOfMsg <= 0))
	{
...
int UnionBufferResponseMessage(unsigned char * msg,int lenOfMsg,long typeOfMsg,PUnionMessageHeader pOriMsgHeader)
{
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionBufferResponseMessage:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	
	if ((msg == NULL) || (pOriMsgHeader == NULL) 
	    || (lenOfMsg > pgunionMsgBufHDL->msgBufDef.maxSizeOfMsg) || (pOriMsgHeader->type <= 0) || (lenOfMsg <= 0))
...
int UnionResetAllMsgBufPosAvailable()
{
	int	ret;
	int	index;
	PUnionMessageHeader	pmsgHeader;
	...
	if ((ret = UnionConnectMsgBufMDL()) < 0)
	{
		UnionUserErrLog("in UnionResetAllMsgBufPosAvailable:: UnionConnectMsgBufMDL!\n");
		return(ret);
	}	

	UnionAuditLog("in UnionResetAllMsgBufPosAvailable:: reset msgBuf!\n");
	...
	UnionResetAllIndexAvailable(pgunionIndexStatusTBL);
	return(0);
}
