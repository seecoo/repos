...
objs=	mngTransSpierBuf.20060808.o	\
	...
	transSpier.defaultHsmIPAddr.20060808.o	\
...
libProducts:	$(null)
	...
	mv transSpierMain.20060808.o		transSpierMain.20060808.2.x_4.x.o
	mv transSpier.20060808.o		transSpier.20060808.2.x.o
	mv transSpierMon.20060808.o		transSpierMon.20060808.2.x.o
	mv *.o					$(CMM2003LIBDIR)
