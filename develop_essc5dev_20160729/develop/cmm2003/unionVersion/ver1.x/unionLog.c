...
#define errCodeDefaultErrCode			-10009	// È±Ê¡´íÎóÂë
...
int UnionGetNameOfLogFile(char *nameOfLogFile)
{
	sprintf(nameOfLogFile,"%s/unionlog.log",getenv("UNIONLOG"));
	return(0);
}
...
void UnionMemNullLog(char *pMessage,unsigned char *pBuffer,int iBufLen)
{
	char	caBuf[40];
	FILE	*UnionLogfile;
