...
int UnionDealServiceCodeE200(PUnionHsmGroupRec phsmGroupRec)
{
	...
	if ((ret = UnionReadRequestXMLPackageValue("body/hsmIP",hsmIP,sizeof(hsmIP))) <= 0)
	{
		...
		{
			UnionUserErrLog("in UnionDealServiceCodeE200:: UnionReadRequestXMLPackageValue[%s]!\n","head/appID");
			return(ret);
		}
		...
		{
			UnionUserErrLog("in UnionDealServiceCodeE200:: UnionSelectRealDBRecord[%s]!\n",sql);
			return(ret);
		}
		else if(ret == 0)
		{
			UnionUserErrLog("in UnionDealServiceCodeE200:: appID[%s]!\n",appID);
	...
	else
	{
		...
		{
			UnionUserErrLog("in UnionDealServiceCodeE200:: hsmIP[%s] error!\n",hsmIP);
		...
		{
			UnionUserErrLog("in UnionDealServiceCodeE200:: hsmIP[%s]!\n",hsmIP);
	...
	{
		UnionUserErrLog("in UnionDealServiceCodeE200:: UnionLocateXMLPackage[%s]!\n","detail");
		return(ret);
	}
	...
	if (ipSpecHsm)
	{
		...
		{
			UnionUserErrLog("in UnionDealServiceCodeE200:: UnionReadXMLPackageValue[%s]!\n","status");
			return(ret);
		}
		...
		if (status[0] != '1')
		{
			UnionUserErrLog("in UnionDealServiceCodeE200:: hsmIP[%s] not online!\n",hsmIP);
	...
	switch(phsmGroupRec->hsmCmdVersionID)
        {
			...
			{
				UnionUserErrLog("in UnionDealServiceCodeE200:: UnionDirectHsmCmd,ret = [%d]!\n",ret);
				return(ret);
			}
			break;
                default:
                	UnionUserErrLog("in UnionDealServiceCodeE200:: phsmGroupRec->hsmCmdVersionID[%d]\n",phsmGroupRec->hsmCmdVersionID);
	...
	{
		UnionUserErrLog("in UnionDealServiceCodeE200:: hsmCmdRes[%s] != resCmdOfTest[%s]!\n",hsmCmdRes,resCmdOfTest);
